...
$data .= "</div>
	...
	if($author != "true"){
	$data .= "<div style='font-size: 9px; color: #808080; font-weight: normal; font-family: tahoma,verdana,arial,sans-serif; line-height: 1.28; text-align: right; direction: ltr;'><a href='http://corporatecostcontrol.com/' target='_blank' style='color: #808080;' title='visit us'>unemployment claims management</a></div>";}
        }
 	return $data;
 }
